package com.bracits.snowflake.api;

import com.bracits.snowflake.model.Person;
import com.bracits.snowflake.service.PersonService;
...
public class PersonController {
    ...
    @PutMapping(path = "/{id}")
    public void updatePerson(@PathVariable("id") String id, @NonNull @RequestBody Person person) {
